...
public class Personal_Data_Revise_home_Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        return inflater.inflate(R.layout.fragment_revise_hone, container, false);
    }
        ...
        public void onClick(View v) {
            switch (v.getId()){
                case R.id.enter:
                    ...
                    MESSAGE.put("聯絡地址", text.getText().toString());
                    db.collection("personal_data")
                            .document(user.getUid())
                            .update(MESSAGE);
                    Intent intent1=new Intent();
                    intent1.setClass(Personal_Data_Revise_home_Fragment.this.getContext(), HomePage.class);
                    intent1.putExtra("id",1);
                    startActivity(intent1);
                    break;
                case R.id.back:
                    Intent intent=new Intent();
                    intent.setClass(Personal_Data_Revise_home_Fragment.this.getContext(),HomePage.class);
