...
public class Account_EmailAuth extends Fragment {
    ...
    private void email_verification() {
        ...
        enter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (text.getText().toString().isEmpty()) {
                    Toast.makeText(Account_EmailAuth.this.getContext(), "請輸入信箱",
                            ...
                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    if (task.isSuccessful()) {
                                        Toast.makeText(Account_EmailAuth.this.getContext(), "已寄送信件至信箱",
                                                Toast.LENGTH_SHORT).show();
                                        ...
                                        Toast.makeText(Account_EmailAuth.this.getContext(), task.getException().getMessage(),
                                                Toast.LENGTH_SHORT).show();
                                    }
                                }
                            });
